...
import { StyleSheet, Image, View, Text, TextInput, TouchableOpacity, TextComponent } from 'react-native'
...
function Main({ navigation }){
    ...
    function hendleRegionChaged(region){
    ...
    return (
        <>
            <MapView 
                onRegionChangeComplete={ hendleRegionChaged } 
